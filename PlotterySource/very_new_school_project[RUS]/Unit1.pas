...
begin
    ...
    Form2.Caption := 'Plottery - Новый проект - ' + projectName;
    Form2.show();
    Form1.hide();
end;
...
begin
    ...
    if currentScene <> nil then begin
        Form2.CoordNet1.theScene := currentScene;
        Form2.Caption := 'Plottery - Проект - ' + projectName;
        Form2.show();
        Form1.hide();
    end;
end;
